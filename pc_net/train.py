...
from dataset import SuctionDataset, collate_fn, minkowski_collate_fn, load_grasp_labels
...
DEFAULT_CHECKPOINT_PATH = os.path.join(cfgs.log_dir, 'checkpoint_minkowski_10.tar')
