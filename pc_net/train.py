...
parser.add_argument('--method_id', default='snet_v1.0', help='Dump dir to save model checkpoint [default: log]')
parser.add_argument('--ckpt_root', default='/media/gpuadmin/rcao/result/uisn', help='Checkpoint dir to save model [default: log]')
...
TRAIN_DATASET = SuctionDataset(cfgs.dataset_root, valid_obj_idxs, camera=cfgs.camera, split='train', num_points=cfgs.num_point, 
                               remove_outlier=False, augment=False, visib_threshold=cfgs.visib_threshold, voxel_size=cfgs.voxel_size)
